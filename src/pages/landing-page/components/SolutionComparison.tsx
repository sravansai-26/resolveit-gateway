      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <motion.div
          ...
          <p className="text-lg md:text-xl text-text-secondary max-w-3xl mx-auto">
            See how ResolveIt transforms the complaint resolution process from bureaucratic
            nightmare to seamless digital experience.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12">
          <motion.div
            ...
            <div className="aspect-[4/3] overflow-hidden rounded-lg mb-6">
              <Image
                src="https://img.rocket.new/generatedImages/rocket_gen_img_1d40e3fdb-1764660298654.png"
                alt="Crowded government office with long queues of people waiting at service counters"
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="w-full min-w-0 bg-primary/5 p-6 md:p-8 rounded-lg border-2 border-primary">
            ...
            <div className="aspect-[4/3] overflow-hidden rounded-lg mb-6">
              <Image
                src="https://img.rocket.new/generatedImages/rocket_gen_img_116b17f40-1764672098874.png"
                alt="Modern smartphone displaying mobile app interface with clean dashboard and tracking features"
                className="w-full h-full object-cover" />
